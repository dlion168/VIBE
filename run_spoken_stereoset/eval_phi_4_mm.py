"""
Evaluation Script for Spoken Stereoset using Phi-4-multimodal with vLLM
Features:
...
def prepare_phi4_inputs_full_perm(batch_items, target_sr=16000):
    """
    Prepare Phi-4 vLLM inputs (full permutation version)
    Features:
    1. Audio Padding (16k)
...
def main():
    ...
    for i in tqdm(range(0, len(items_to_run), chunk_size), desc=f"{model_short_name}"):
        ...
        try:
            ...
            inputs_list = prepare_phi4_inputs_full_perm(batch_items, target_sr=16000)
